...
function QuestionList() {
    ...
    const [columns] = useState<TableColumnModel[]>([
        { field: 'content', label: 'Content', iconASC: faSortAlphaAsc, iconDESC: faSortAlphaDesc, isEnum: false, enum: null, sortabled: true },
        { field: 'questionType', label: 'Type', iconASC: faSortAmountAsc, iconDESC: faSortAmountDesc, isEnum: true, enum: QuestionType, sortabled: true },
    ...
    const onDelete = async (item: any) => {
        try {
            const response = await QuestionService.remove(item.id);
    ...
    return (
        <section className="w-full">
            ...
            <TablePagination data={data} defaultOrderBy={'content'} pageInfo={pageInfo} columns={columns} onEdit={onEdit} onDelete={onDelete} onSearch={onSearch} />

            {/* Details Component */}
            {/* <div id="detail-form" ref={detailForm}>
                {isShowDetail && (<QuestionDetail item={selectedItem} onCancel={() => onCancelDetail()} />)}
            </div> */}
